...
export class ConstantService {
  ...
  static message: IMessages = { 
    ...
    sudentMealAttendance: 'Student Meal Attendance',
  ...
  static dbKeyNames: IDBKeyNames = {
    ...
    studentMealAttendanceData: "studentMealAttendanceData",
    hmstudentData: "hmstudentData",
    hmstudentAttendanceData: "hmstudentAttendanceData",
    hmstudentMealAttendanceData: "hmstudentMealAttendanceData",
    userId: 'userId',
